...
const Banner = () => {
    return (
        <div>
            <div className="hero relative " style={{ backgroundImage: 'url(https://i.ibb.co/0Fz5h7H/index-overlay.png)', height: '650px' }}>
          ...
          <div className="absolute left-[28%]">
                <div className="flex justify-center my-10 md:-mt-12   ">
